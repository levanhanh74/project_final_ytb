            ...
            <nav className="navbar navbar-expand-lg navbar-light p-4">
                <div className="container-fluid container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav w-75 justify-content-center col-6">
                            <div className="d-flex w-75 w-sm-100">
                            ...
                            <div className="header_customer_col_account w-80">
                                <div className="header_customer_col_account_account w-100">
                                    <div className="d-flex  align-items-center d-sm-block">
                                        ...
                                        <div className="header_customer_col_account_cart_cart ps-3 ps-sm-0">
